...
* **グローバル承認プロセス：**&#x200B;これらは、設定/プロセス/承認セクションで作成され、特定のステータスによってトリガーできます。 &#x200B;複数の承認者や段階的な承認が関与する場合もあります。
* **単回使用の承認プロセス：**&#x200B;これらはオブジェクト固有であり、共有できません。 &#x200B; ゼロから作成することも、グローバル承認プロセスを編集して変換することで作成することもできます。
