---
title: プロジェクトとタスクにマイルストーンパスを適用する
...
* [プロジェクトとタスクにマイルストーンパスを適用する](/help/administration-and-setup/approval-processes-and-milestone-paths/creating-milestones.md)
