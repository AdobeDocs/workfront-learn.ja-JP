...
1. **必要なトピックは何ですか？** &#x200B; – 送信されたリクエストを分類するキューのトピックで、管理とカスタマイズが簡単になります。&#x200B;
1. **トピックをさらに整理できますか？** &#x200B; - トピックグループを使用すると、関連するキューのトピック（パンフレット、名刺、「プリント」の下の看板など）をより優れた整理でグループ化できます。&#x200B;
1. **リクエストは誰に割り当てるべきですか？** &#x200B; - ルーティングルールによって、送信が特定のチーム、役割、またはユーザーに自動的に転送され、リクエストが見落とされないようにします。&#x200B;
