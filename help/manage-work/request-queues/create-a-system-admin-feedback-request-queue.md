...
>[!PREREQUISITES]
>
>* [Workfrontでリクエストキューを作成](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/request-queues/create-a-request-queue.html?lang=ja)
>* [Workfrontでリクエストフローを作成](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/manage-work/request-queues/create-a-request-flow.html?lang=ja)
>* ルーティングルールとカスタムフォームを使用するリクエストキューの作成に既に慣れている

このビデオでは、システム管理者向けのフィードバックリクエストキューの作成に関するステップバイステップガイドを提供します。&#x200B;このキューの目的は、システム管理者が作成したプロセスとワークフローに関するユーザーからのフィードバックを収集し、改善と最適化を可能にすることです。この動画では、プロセス改善におけるユーザー参加と透明性の重要性を強調し、管理者がフィードバックレポートをユーザーと共有することを促しています。&#x200B;レポートとカスタムフォームの作成に関するチュートリアルへのリンクを提供しています。


>[!VIDEO](https://video.tv.adobe.com/v/3450498/?captions=jpn&quality=12&learn=on&enablevpops=0)
...
* **レポート統合：** レポートは、フィードバック送信を要約し、管理者がユーザー入力を追跡してアクションを実行しやすくします。 &#x200B;れらのレポートをユーザーと共有することで、透明性が向上し、参加を促すことができます。
