...
このビデオでは、システム管理者向けのフィードバックリクエストキューの作成に関するステップバイステップガイドを提供します。
&#x200B;このキューの目的は、システム管理者が作成したプロセスとワークフローに関するユーザーからのフィードバックを収集し、改善と最適化を可能にすることです。
この動画では、プロセス改善におけるユーザー参加と透明性の重要性を強調し、管理者がフィードバックレポートをユーザーと共有することを促しています。
&#x200B;レポートとカスタムフォームの作成に関するチュートリアルへのリンクを提供しています。
