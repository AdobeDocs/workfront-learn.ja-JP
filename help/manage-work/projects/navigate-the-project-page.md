...
11. **[!UICONTROL 書き出し]:** タスク・リストまたは選択したタスクをPDF、スプレッドシート、タブ区切りファイルにエクスポートします。
...
14. **概要パネル：** 概要パネルでは、選択したタスクに関する情報を簡単に確認できます。 アイコンをクリックして開くか閉じます。
15. **タスクをさらに追加** インライン編集を使用して別のタスクをタスクリストの下部に追加するには、ここをクリックします。
