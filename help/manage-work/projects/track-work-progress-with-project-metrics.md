...
* **プロジェクト指標へのアクセス：** プロジェクトの左側のパネルにある「指標」タブに移動して、進捗状況を追跡します。&#x200B;下にスクロールして「詳細を表示」をクリックして検索する必要がある場合がありま&#x200B;。
...
* **担当者ごとの指標：** ステータス（完了、未完了、今後の予定、期限切れ）に基づいて、担当者ごとのタスクを表示します。&#x200B;設定は、今後の訪問時に保存されます。&#x200B;
