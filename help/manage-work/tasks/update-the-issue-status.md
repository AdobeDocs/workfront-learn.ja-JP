...
* **問題とタスクの違い** イシューは、イシューが予定外の作業を表すというタスクとは異なります。 イシューを予定作業として含める必要がある場合は、タスクまたはプロジェクトに変換する必要があります。
* **プロジェクトの問題を素早く確認することが重要なのはなぜですか？** プロジェクトで未解決の問題がある場合、その問題はプロジェクトのスケジュールや予算にとって潜在的なリスクとなり、その問題を調査し、適切なアクションを実施または推奨できる担当者に迅速に割り当てる必要があります。
