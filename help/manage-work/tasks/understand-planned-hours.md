...
この動画では、タスクを完了するために必要な時間の見積もりである予定時間の概念を説明しています。
Workfrontでは、リソースの過剰または過小配分を把握するために、予定時間を活用します。
また、タスクに費やした時間の追跡、今後の見積もりの改善、従業員との期待値の明確化にも役立ちます。
...
* [時間を記録](https://experienceleague.adobe.com/ja/docs/workfront/using/timesheets/create-and-manage-timesheets-in-adobe-workfront/log-time)
