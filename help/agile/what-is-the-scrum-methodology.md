...
スクラム手法は、柔軟性モデルを包含しますが、他の手法とは異なり、プロダクトオーナーやスクラムマスターなど、チームのメンバーの役割を定義し、作業を定義して遂行するための慣行を定義しています。
...
バックログが調整され、優先順位が付けられたら、次はイテレーションを計画します （多くの組織では、「スプリント」と「イテレーション」という言葉を区別せずに使用しています）。 チームは、準備完了と見なされるストーリーにもとづいて、完了するストーリーを決定します。 チームが割り当てを行い、イテレーションの期間を決定します。
