...
次の列を持つ「タスクステータスビュー」という名前のタスクビューを作成します。
...
![新しいビューを作成する画面の画像](assets/view-exercise.png)

1. タスクリストレポートで、**[!UICONTROL ビュー]**&#x200B;ドロップダウンメニューに移動し、「**[!UICONTROL 新しいビュー]**」を選択します。
1. ビューに「タスクステータスビュー」という名前を付けます。
1. 次の列（[!UICONTROL 予定時間]、[!UICONTROL 先行タスク]、[!UICONTROL 開始日]、および[!UICONTROL 期限]）を削除します。 
1. 「**[!UICONTROL 列を追加]**」をクリックします。 
1. [!UICONTROL この列に表示]フィールドに「ステータス」と入力し、[!UICONTROL タスク]フィールドソースの下の「ステータス」を選択します。
1. 「**[!UICONTROL 列を追加]**」を再度クリックします。
1. [!UICONTROL この列に表示]フィールドに「ステータス」と入力し、[!UICONTROL タスク]フィールドソースの下の「進捗ステータス」を選択します。
1. 「**[!UICONTROL 列を追加]**」を再度クリックします。
1. [!UICONTROL この列に表示]フィールドで「ステータス」と入力し、タスクフィールドソースで「ステータスアイコン」を選択します。
