...
description: キャンバスダッシュボードでグラフレポートを作成する方法を説明します。
activity: use
...
[&#x200B; キャンバスダッシュボードでのグラフレポートの作成 &#x200B;](https://experienceleague.adobe.com/ja/docs/workfront/using/reporting/canvas-dashboards/add-reports/build-chart-report)
