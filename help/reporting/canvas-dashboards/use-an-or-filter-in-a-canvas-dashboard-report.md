---
title: カンバスダッシュボードレポートでのOR フィルターの適用
description: キャンバスダッシュボードレポートで OR フィルターを使用する方法について説明します。
activity: use
...
>[!VIDEO](https://video.tv.adobe.com/v/3475382/?captions=jpn&quality=12&learn=on&enablevpops=1)
