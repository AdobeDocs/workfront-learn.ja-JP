---
title: Workfrontのフィルターの基本的なテキストモードの調査
...
# Workfrontのフィルターの基本的なテキストモードの調査
...
>[!VIDEO](https://video.tv.adobe.com/v/3412686/?captions=jpn&quality=12&learn=on&enablevpops=0)
