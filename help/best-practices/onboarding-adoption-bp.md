...
* Adobe Workfrontなどの新しいプロセスやソフトウェアを導入する場合は、月に少なくとも1時間は「なぜ？」を伝えるようにしましょう。
...
Workfrontに関するトレーニングを実施する必要はありません。 独自のトレーニングを制作することもできますが、自身でトレーニングを行う時間やカスタムトレーニングを購入する時間がない場合は、Experience Leagueを活用して、どのような役割でも受講者が自主的にトレーニングを実施できるようにするうえで、有益なリソースが提供されます
...
[導入調査に関する Workfront ガイドをダウンロード](../assets/adoption-survey.pdf)
